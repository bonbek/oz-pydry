...
def run():
    ...
    st.markdown(
        ...
        Bien avant l'arrivée des systèmes informatiques, certains étudiaient les différentes conditions climatique pour établir des prédictions.

        Depuis l'instalation de sondes et l'utilisations de systèmes informatiques, la précision de ces prédictions météorologique est sensiblement améliorée.
        ...
        En somme, la prévision de la pluie en Australie est cruciale pour la sécurité et le bien-être des êtres humains, de la faune, la flore et de l'économie.

        Nous souhaitons donc contribuer à la précision des prévisions météorologique en Australie.
        Pour cela, nous utiliserons leurs données recensées avec nos modèles utilisant les outils de machine learning et de deep learning.
